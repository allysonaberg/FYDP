    ...
    return (
		...
		<Modal style={{"backgroundColor" : "black !important"}} show={this.props.isPanelOpen} close={() => this.props.showPanel(false)}>
			<div class="container" style={{"padding": "2em"}}>
				...
				<div class="container" style={{"display": "block", "text-align": "center"}}>
					<p style={{"color": "#6583FE", "font-weight": "bold", "padding-bottom": "15px", "padding": "10px"}}><img src={uhoh} style={{"padding-right": "10px"}}/>You can configure the design in your Shopify Editor</p>
				</div>
