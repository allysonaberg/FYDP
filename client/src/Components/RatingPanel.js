...
const RatingPanel = (props) => {
	return (
		<div className='container' style={{backgroundColor: props.background, "boxShadow": "rgba(0, 0, 0, 0.2) 0px 2px 4px 0px"}}>
			<p style={{color: "var(--textGrey)", "fontWeight": "Bold"}}>{props.title}</p>
			...
			<div style={{"backgroundColor": "#F0F9FF", "marginTop": "20px"}}>
				<p style={{"color": "#6583FE", "fontWeight": "bold", "paddingBottom": "15px", "padding": "10px"}}><img src={uhoh} style={{"paddingRight": "10px"}}/>About Our Calculations</p>
