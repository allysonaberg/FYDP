...
const RatingPanel = (props) => {
	return (
		<div className='container' style={{backgroundColor: props.background, "box-shadow": "rgba(0, 0, 0, 0.2) 0px 2px 4px 0px"}}>
			...
			<img style={{"padding-bottom": "20px", "padding-top": "20px", "maxWidth": "120%"}} src={img1}/>
			...
			<div style={{"background-color": "#F0F9FF", "margin-top": "20px"}}>
				<p style={{"color": "#6583FE", "font-weight": "bold", "padding-bottom": "15px", "padding": "10px"}}><img src={uhoh} style={{"padding-right": "10px"}}/>About Our Calculations</p>
				<p style={{"padding": "10px", "padding-top": "5px"}}>Lorem ipsum dolor sit amet, consectetur adipise elit. Curabitur sed tincidunt erat. Maecenas quis dui risus. Vivamus mattis volutpat enim ac sagittis </p>
			</div>
		</div>
	)
}
